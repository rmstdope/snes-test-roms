// Colour-math fixed-colour subtract + half test (NESER #2880)
//
// Shared quadrant scene with CGWSEL addend = fixed colour (COLDATA
// all planes = 9) and CGADSUB = subtract + half, math on
// BG1 + backdrop. Verifies the fixed-colour subtract path combined
// with halving (halving IS applied for the fixed-colour addend when
// the sub screen is not selected as the addend source).
//
...
define REGION = Japan
define ROM_NAME = "NESER CM FIXED SUBHALF"
define VERSION = 0
