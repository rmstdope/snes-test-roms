// Mode 7 identity matrix baseline
// (NESER #2881)
//
// Identity matrix (A = D = 1.0), no scroll, no flips: the screen
// shows the top-left 256x224 px of the scene (red corner block,
// white border, checkerboard).
//
...
define REGION = Japan
define ROM_NAME = "NESER M7 IDENTITY"
define VERSION = 0
