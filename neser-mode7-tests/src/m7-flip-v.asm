// Mode 7 vertical screen flip (M7SEL bit 1)
// (NESER #2881)
//
// Identity matrix with M7SEL V-flip: the screen must mirror
// top-bottom (red corner block at the bottom).
//
...
define REGION = Japan
define ROM_NAME = "NESER M7 FLIP V"
define VERSION = 0
...
function SetupPpu {
    ...
    lda.b   #M7SEL.outOfScreen.repeat | M7SEL.vFlip
    sta.w   M7SEL

    SetMode7Matrix(0x0100, 0, 0, 0x0100, 0, 0, 0, 0)
