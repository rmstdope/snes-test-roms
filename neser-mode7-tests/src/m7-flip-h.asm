// Mode 7 horizontal screen flip (M7SEL bit 0)
// (NESER #2881)
//
// Identity matrix with M7SEL H-flip: the screen must mirror
// left-right (red corner block on the right).
//
...
define REGION = Japan
define ROM_NAME = "NESER M7 FLIP H"
define VERSION = 0
...
function SetupPpu {
    ...
    lda.b   #M7SEL.outOfScreen.repeat | M7SEL.hFlip
    sta.w   M7SEL
