// Mode 7 zoom-out with out-of-screen tile 0 fill (M7SEL = tile 0)
// (NESER #2881)
//
// A = D = 8.0 shows a 2048x1792 px source span: with M7SEL
// out-of-screen = tile 0 everything beyond the 1024x1024 map
// must be filled with the orange tile-0 marker colour.
//
...
define REGION = Japan
define ROM_NAME = "NESER M7 SCALE TILE0"
define VERSION = 0
