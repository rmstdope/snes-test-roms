// Mode 7 zoom-out with out-of-screen wrap (M7SEL = repeat)
// (NESER #2881)
//
// A = D = 8.0 shows a 2048x1792 px source span, exceeding the
// 1024x1024 map: with M7SEL out-of-screen = repeat the map must
// tile (wrap) in both directions, showing four corner-marker
// meeting points.
//
...
define REGION = Japan
define ROM_NAME = "NESER M7 SCALE WRAP"
define VERSION = 0
